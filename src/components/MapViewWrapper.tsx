    ...
    <div className="w-full h-full overflow-hidden relative">
      ...
      {count > 0 && (
        <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col pointer-events-none">
          ...
          {drawerOpen && (
            <div className="pointer-events-auto bg-blue-950/95 backdrop-blur-sm border-t border-blue-700 max-h-[45vh] overflow-y-auto">
          ...
          <button
            ...
            className="pointer-events-auto self-center mb-2 flex items-center gap-1.5 px-3 py-1.5 bg-blue-900/90 backdrop-blur-sm border border-blue-600 rounded-full text-xs text-blue-300 hover:text-white hover:bg-blue-800 active:bg-blue-800 transition-colors cursor-pointer shadow-lg"
          >
