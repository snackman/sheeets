    ...
    <div className="w-full h-full overflow-hidden relative">
      ...
      {count > 0 && (
        <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col pointer-events-none">
          ...
          {drawerOpen && (
            <div className="pointer-events-auto bg-violet-950/95 backdrop-blur-sm border-t border-violet-800 max-h-[45vh] overflow-y-auto">
          ...
          <button
            ...
            className="pointer-events-auto self-center mb-2 flex items-center gap-1.5 px-3 py-1.5 bg-violet-900/90 backdrop-blur-sm border border-violet-700 rounded-full text-xs text-violet-200 hover:text-white hover:bg-violet-800 active:bg-violet-800 transition-colors cursor-pointer shadow-lg"
          >
