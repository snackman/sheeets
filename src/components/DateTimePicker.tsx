  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="bg-blue-800 border border-blue-600 rounded text-white text-sm font-medium px-2 py-1.5 focus:border-yellow-500 focus:outline-none cursor-pointer whitespace-nowrap hover:bg-blue-700 transition-colors"
      >
