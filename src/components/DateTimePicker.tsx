  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="bg-sky-800 border border-sky-700 rounded text-white text-sm font-medium px-2 py-1.5 focus:border-teal-500 focus:outline-none cursor-pointer whitespace-nowrap hover:bg-sky-700 transition-colors"
      >
      ...
      {isOpen && (
        <div
          ref={listRef}
          className="absolute top-full left-0 mt-1 bg-sky-900 border border-sky-700 rounded-lg shadow-xl max-h-52 overflow-y-auto z-50"
