  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-2 bg-sky-900 border border-sky-700 text-white placeholder-sky-400 rounded-lg text-sm focus:outline-none focus:border-teal-500 transition-colors"
      />
      {localValue && (
        <button
          onClick={handleClear}
          className="absolute right-3 top-1/2 -translate-y-1/2 text-sky-400 hover:text-sky-200 transition-colors cursor-pointer"
