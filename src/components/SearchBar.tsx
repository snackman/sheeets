  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-2 bg-blue-900 border border-blue-600 text-white placeholder-blue-400 rounded-lg text-sm focus:outline-none focus:border-orange-500 transition-colors"
      />
      {localValue && (
        <button
          onClick={handleClear}
