  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-2 bg-[var(--theme-filter-control-bg)] border border-[var(--theme-filter-control-border)] text-[var(--theme-text-primary)] placeholder-[var(--theme-filter-text)] rounded-lg text-sm focus:outline-none focus:border-[var(--theme-accent)] transition-colors"
      />
      {localValue && (
        <button
          onClick={handleClear}
