  ...
  return (
    ...
    >
      <div className="flex gap-4 overflow-hidden rounded-xl bg-purple-500/5 border border-purple-500/30 ring-1 ring-purple-500/40 hover:bg-purple-500/10 p-4 transition-colors">
        {ad.imageUrl && (
          <div className="w-[120px] h-[90px] flex-shrink-0 rounded-lg overflow-hidden bg-stone-800">
            <img
              src={ad.imageUrl}
              alt={ad.title}
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-stone-400 line-clamp-2 mb-2">{ad.description}</p>
