...
const PLATFORM_LOGOS: Record<string, string> = {
  ...
  friend: `data:image/svg+xml,${encodeURIComponent('<svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"><rect width="36" height="36" rx="6" fill="#fafaf9"/><g transform="translate(8 7)"><path d="M4.5 1.5a.75.75 0 0 1 .75.75V3h1.5V2.25a.75.75 0 0 1 1.5 0V3h4.5V2.25a.75.75 0 0 1 1.5 0V3h1.5V2.25a.75.75 0 0 1 1.5 0V3.5A2.5 2.5 0 0 1 19.5 6v9.5a2.5 2.5 0 0 1-2.5 2.5H4a2.5 2.5 0 0 1-2.5-2.5V6A2.5 2.5 0 0 1 3.75 3.512V2.25a.75.75 0 0 1 .75-.75ZM3 8v7.5a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V8H3Zm1.75 2h2.5v2.25h-2.5V10Zm4.25 0h2.5v2.25H9V10Zm4.25 0h2.5v2.25h-2.5V10ZM4.75 13.75h2.5V16h-2.5v-2.25ZM9 13.75h2.5V16H9v-2.25Z" fill="#0c0a09"/></g></svg>')}`,
};
