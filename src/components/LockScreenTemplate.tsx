...
const PLATFORM_LOGOS: Record<string, string> = {
  ...
  friend: `data:image/svg+xml,${encodeURIComponent('<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="4" fill="#fafaf9"/><rect x="3.5" y="5" width="17" height="15" rx="2" fill="#0c0a09"/><rect x="5" y="10" width="14" height="9" rx="1" fill="#fafaf9"/><rect x="7" y="3" width="2" height="4" rx="1" fill="#0c0a09"/><rect x="15" y="3" width="2" height="4" rx="1" fill="#0c0a09"/><rect x="6.5" y="12" width="3" height="2.5" rx="0.5" fill="#0c0a09"/><rect x="10.5" y="12" width="3" height="2.5" rx="0.5" fill="#0c0a09"/><rect x="14.5" y="12" width="3" height="2.5" rx="0.5" fill="#0c0a09"/><rect x="6.5" y="15.5" width="3" height="2.5" rx="0.5" fill="#0c0a09"/><rect x="10.5" y="15.5" width="3" height="2.5" rx="0.5" fill="#0c0a09"/></svg>')}`,
};
