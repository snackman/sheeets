        ...
        <div className="p-3 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-9 h-5 rounded-full transition-colors cursor-pointer ${
                isPublic ? 'bg-yellow-500' : 'bg-blue-700'
              }`}
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-600 disabled:opacity-50 text-white text-xs font-medium rounded-lg transition-colors cursor-pointer"
            >
              {saving ? (
