          ...
          <div className="px-4 py-5">
            {step === 'email' && (
              <form onSubmit={handleEmailSubmit}>
                ...
                <div className="flex items-center gap-2 bg-blue-950 border border-blue-600 rounded-lg px-3 py-2.5 focus-within:border-orange-500 transition-colors">
                ...
                <div className="flex justify-center gap-2" onPaste={handlePaste}>
                  {code.map((digit, i) => (
                    <input
                      ...
                      className="w-10 h-12 bg-blue-950 border border-blue-600 rounded-lg text-white text-center text-lg font-bold outline-none focus:border-orange-500 transition-colors"
                    />
                  ))}
                </div>
            ...
            <div className="bg-blue-900 border border-blue-700 rounded-xl shadow-2xl w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="max-h-[80vh] overflow-y-auto px-4 py-5 space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <input
                      ...
                      className="w-full bg-blue-950 border border-blue-600 rounded-lg text-white text-sm px-3 py-2 focus:border-orange-500 focus:outline-none placeholder:text-blue-500"
                    />
                  </div>

                  <div>
                    <div className="flex items-center bg-blue-950 border border-blue-600 rounded-lg focus-within:border-orange-500">
                ...
                <div className="border-t border-blue-700 pt-4 space-y-3">
                  ...
                  {/* Search for friends */}
                  <div className="flex items-center gap-2 bg-blue-950 border border-blue-600 rounded-lg px-3 py-2 focus-within:border-orange-500 transition-colors">
