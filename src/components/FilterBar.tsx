            ...
            {activeFilterCount > 0 && (
              <span className={clsx(
                ...
                expanded
                  ...
                  : 'bg-[var(--theme-filter-badge-bg)] text-[var(--theme-filter-badge-text)] border border-[var(--theme-filter-badge-border)] group-hover:text-[var(--theme-accent)] group-hover:border-[var(--theme-accent)] group-hover:bg-transparent'
              )}>
                {activeFilterCount}
              </span>
            )}
