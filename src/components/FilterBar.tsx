...
export function FilterBar({
  ...
  return (
    <div className="relative bg-violet-950 border-b border-violet-900 z-30">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-3 space-y-3">
        ...
        <div className="flex items-center gap-3 lg:justify-center">
            ...
            <>
              ...
              <div className="sm:hidden shrink-0">
                <button
                  ...
                  className={clsx(
                    'flex items-center gap-1.5 px-3 py-2 rounded-lg bg-cyan-500 text-white font-semibold cursor-pointer',
                ...
                {confOpen && (
                  <>
                    ...
                    <div
                      className="fixed z-[70] bg-violet-900 border border-violet-800 rounded-lg shadow-xl overflow-hidden min-w-[180px]"
                      style={{
                        ...
                        <button
                          ...
                          className={clsx(
                            ...
                            filters.conference === conf
                              ...
                              : 'text-violet-200 hover:bg-violet-800 active:bg-violet-800'
                          )}
                        >
                          {conf}
                        </button>
              ...
              {/* Desktop: inline tabs */}
              <div className="hidden sm:flex rounded-lg border border-violet-800 overflow-hidden">
                {availableConferences.map((conf) => (
                  <button
                    key={conf}
          ...
          <div className="hidden md:flex items-center gap-2 flex-1 max-w-sm">
            ...
            {onSubmitEvent && (
              <button
                ...
                className="shrink-0 w-9 h-9 flex items-center justify-center rounded-lg bg-cyan-500 hover:bg-cyan-600 text-white transition-colors cursor-pointer"
          ...
          <button
            ...
            className={clsx(
              ...
              filters.nowMode
                ...
                : 'bg-violet-900 text-violet-300 hover:text-violet-100 hover:bg-violet-800 active:text-violet-100 active:bg-violet-800 border border-violet-800'
            )}
          >
          ...
          >
            ...
            Filters
            {activeFilterCount > 0 && (
              <span className="bg-cyan-500 text-white text-[10px] font-bold min-w-[18px] h-[18px] flex items-center justify-center rounded-full px-1">
                {activeFilterCount}
              </span>
            )}
          </button>
        ...
        {expanded && (
          <div className="space-y-3 pt-1 sm:relative absolute left-0 right-0 sm:bg-transparent bg-violet-950 sm:px-0 px-2 sm:pb-0 pb-4 sm:shadow-none shadow-lg shadow-black/40">
            {/* Now mode notice */}
            {filters.nowMode && (
              ...
              return (
                <div className={clsx('flex gap-3 items-end', filters.nowMode && 'opacity-30 pointer-events-none')}>
                  <div className="w-40 shrink-0">
                    <div className="text-xs uppercase tracking-wider text-violet-300 mb-2">Start</div>
                    <DateTimePicker
                  ...
                  {(availableTypes.length > 0) && (
                    <div className="flex-1 min-w-0">
                      <div className="text-xs uppercase tracking-wider text-violet-300 mb-1">Type</div>
                          ...
                          return (
                            <button
                              ...
                              className={clsx(
                                ...
                                isActive
                                  ? 'text-white'
                                  : 'bg-violet-800 text-violet-200 hover:bg-violet-700 active:bg-violet-700'
                              )}
            ...
            {(() => {
              ...
              return (
                <div className={clsx('flex gap-3 items-end', filters.nowMode && 'opacity-30 pointer-events-none')}>
                  <div className="w-40 shrink-0">
                    <div className="text-xs uppercase tracking-wider text-violet-300 mb-2">End</div>
                    <DateTimePicker
                  ...
                  {availableVibes.length > 0 && (
                    <div className="flex-1 min-w-0">
                      <div className="text-xs uppercase tracking-wider text-violet-300 mb-1">Tags</div>
                      <div className="overflow-x-auto flex gap-2 pb-1">
            ...
            {friendsForFilter.length > 0 && (
              <div>
                <div className="text-xs uppercase tracking-wider text-violet-300 mb-1">
                  Friends
                </div>
                <div className="overflow-x-auto flex gap-2 pb-1">
            ...
            {activeFilterCount > 0 && (
              <div className="flex items-center">
                <button
                  ...
                  className="flex items-center gap-1.5 text-cyan-400 hover:text-cyan-300 active:text-cyan-300 text-sm font-medium whitespace-nowrap transition-colors cursor-pointer"
                >
