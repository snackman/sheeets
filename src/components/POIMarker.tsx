      ...
      <div className="relative" style={{ width: 0, height: 0 }}>
        ...
        {showLabel && (
          <div
            ...
            onClick={handleClick}
          >
            <div className="px-2 py-0.5 rounded bg-violet-900/90 hover:bg-violet-800/90 text-[10px] text-white max-w-[120px] leading-tight transition-colors whitespace-nowrap truncate">
              {poi.name}
            </div>
          </div>
        )}
