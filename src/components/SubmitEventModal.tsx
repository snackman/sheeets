              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-blue-950 border border-blue-600 rounded-lg text-white text-sm px-3 py-2 focus:border-orange-500 focus:outline-none"
                  >
                    {EVENT_TABS.map((t) => (
                ...
                <div className="flex items-end gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-blue-950 border border-blue-600 rounded-lg text-white text-sm px-3 py-1.5 focus:border-orange-500 focus:outline-none cursor-pointer [&::-webkit-calendar-picker-indicator]:invert"
                ...
                <div className="flex items-center gap-6">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-blue-600 bg-blue-950 text-orange-500 focus:ring-orange-500 focus:ring-offset-0 cursor-pointer"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-blue-950 border border-blue-600 rounded-lg text-white text-sm px-3 py-2 focus:border-orange-500 focus:outline-none placeholder:text-blue-500 resize-none"
                  />
                </div>
