...
export function ItineraryPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 z-[70] h-full w-full max-w-md bg-violet-950 border-l border-violet-800 shadow-2xl transition-transform duration-300 ease-in-out pt-[var(--safe-area-top)] ${
      ...
      >
          ...
          <div className="flex items-center gap-1">
            {itineraryEvents.length > 0 && (
              <>
                <Link
                  href="/itinerary"
                  className="p-1.5 text-violet-300 hover:text-cyan-400 active:text-cyan-400 transition-colors"
                ...
                <button
                  ...
                  className="p-1.5 text-violet-300 hover:text-cyan-400 active:text-cyan-400 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  disabled={exporting}
                  className="p-1.5 text-violet-300 hover:text-cyan-400 active:text-cyan-400 transition-colors cursor-pointer disabled:opacity-50"
        ...
        {conferences.length > 1 && (
          <div className="flex border-b border-violet-900 px-4">
              ...
              <button
                ...
                className={`px-3 py-2 text-xs font-medium transition-colors cursor-pointer border-b-2 ${
                  selectedConference === conf
                    ...
                    : 'border-transparent text-violet-300 hover:text-violet-100 active:text-violet-100'
                }`}
              >
                {conf.replace(/ 2026$/, '')}
              </button>
                            ...
                            >
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <button
                                  ...
                                  className="shrink-0 p-1 text-violet-400 hover:text-red-400 active:text-red-400 transition-colors cursor-pointer"
                              ...
                              {/* Time */}
                              <p className={`text-violet-300 text-xs mt-1 ${canDrag ? 'ml-6' : ''}`}>
                                {timeDisplay}
                              </p>
                ...
                {showClearConfirm ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-violet-800 hover:bg-violet-700 active:bg-violet-700 text-violet-200 text-xs font-medium rounded transition-colors cursor-pointer"
                    >
                      Cancel
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-violet-900 hover:bg-violet-800 active:bg-violet-800 border border-violet-800 text-violet-300 hover:text-violet-200 active:text-violet-200 rounded-lg text-sm font-medium transition-colors cursor-pointer"
                  >
