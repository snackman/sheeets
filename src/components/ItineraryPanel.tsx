...
export function ItineraryPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 z-[70] h-full w-full max-w-md bg-blue-950 border-l border-blue-700 shadow-2xl transition-transform duration-300 ease-in-out pt-[var(--safe-area-top)] ${
          ...
          <div className="flex items-center gap-1">
            {itineraryEvents.length > 0 && (
              <>
                <Link
                  href="/itinerary"
                  className="p-1.5 text-blue-400 hover:text-yellow-400 active:text-yellow-400 transition-colors"
                ...
                <button
                  ...
                  className="p-1.5 text-blue-400 hover:text-yellow-400 active:text-yellow-400 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  disabled={exporting}
                  className="p-1.5 text-blue-400 hover:text-yellow-400 active:text-yellow-400 transition-colors cursor-pointer disabled:opacity-50"
            ...
            <button
              onClick={onClose}
              className="p-1 text-blue-400 hover:text-white active:text-white transition-colors cursor-pointer"
              ...
              <button
                ...
                className={`px-3 py-2 text-xs font-medium transition-colors cursor-pointer border-b-2 ${
                  selectedConference === conf
                    ...
                    : 'border-transparent text-blue-400 hover:text-blue-200 active:text-blue-200'
                }`}
              >
                {conf.replace(/ 2026$/, '')}
              </button>
        ...
        <div className={`overflow-y-auto ${conferences.length > 1 ? 'h-[calc(100%-95px)]' : 'h-[calc(100%-57px)]'} px-4 pb-4`}>
          {itineraryEvents.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <CalendarX className="w-12 h-12 text-blue-600 mb-4" />
            ...
            <>
              ...
              <div ref={captureRef} className="bg-blue-950">
                ...
                <div className="pt-3 pb-1 px-1 flex items-center gap-2">
                  ...
                  <span className="text-xs text-blue-500">— My Itinerary</span>
                </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            {dropIndicator.showAbove && (
                              <div className="absolute -top-1.5 left-0 right-0 h-0.5 bg-yellow-500 rounded-full z-10" />
                            )}

                            <div
                              className={`bg-blue-900 rounded-lg p-3 border transition-opacity ${
                                hasConflict
                                  ? 'border-amber-500/40'
                                  : 'border-blue-700'
                            ...
                            >
                              ...
                              <div className="flex items-start gap-2">
                                {canDrag && (
                                  <div
                                    ...
                                    className="shrink-0 pt-0.5 text-blue-600 hover:text-blue-400 active:text-blue-400 cursor-grab active:cursor-grabbing touch-none select-none"
                                ...
                                <button
                                  ...
                                  className="shrink-0 p-1 text-blue-500 hover:text-red-400 active:text-red-400 transition-colors cursor-pointer"
                              ...
                              {/* Time */}
                              <p className={`text-blue-400 text-xs mt-1 ${canDrag ? 'ml-6' : ''}`}>
                                {timeDisplay}
                              </p>
                            ...
                            {dropIndicator.showBelow && (
                              <div className="absolute -bottom-1.5 left-0 right-0 h-0.5 bg-yellow-500 rounded-full z-10" />
                            )}
                          </div>
                        );
                      })}
                ...
                {showClearConfirm ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-blue-800 hover:bg-blue-700 active:bg-blue-700 text-blue-300 text-xs font-medium rounded transition-colors cursor-pointer"
                    >
                      Cancel
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-900 hover:bg-blue-800 active:bg-blue-800 border border-blue-700 text-blue-400 hover:text-blue-300 active:text-blue-300 rounded-lg text-sm font-medium transition-colors cursor-pointer"
                  >
