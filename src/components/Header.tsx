...
export function Header({
  ...
  return (
    <>
      <header className="sticky top-0 shrink-0 z-50 bg-violet-950/95 backdrop-blur-sm border-b border-violet-900">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-sm cursor-pointer transition-colors ${
                isItineraryActive
                  ? 'bg-cyan-500 text-white border-cyan-500 hover:bg-cyan-600 active:bg-cyan-600'
                  : 'border-violet-800 bg-violet-900 text-violet-300 hover:text-violet-100 hover:bg-violet-800 active:text-violet-100 active:bg-violet-800'
              }`}
            ...
            {!loading && (
              user ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-violet-800 bg-violet-900 text-violet-300 hover:text-violet-100 hover:bg-violet-800 active:text-violet-100 active:bg-violet-800 transition-colors text-sm cursor-pointer"
                >
