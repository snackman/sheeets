      ...
      <div className="min-h-screen bg-blue-950 flex items-center justify-center p-4">
        ...
        >
          ...
          <input
            ...
            className="w-full bg-blue-950 border border-blue-600 rounded-lg text-white text-sm px-3 py-2 focus:border-orange-500 focus:outline-none placeholder:text-blue-500 mb-3"
            autoFocus
          />
          <button
            type="submit"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-blue-900 border border-blue-700 rounded-lg text-white text-sm pl-9 pr-3 py-1.5 focus:border-orange-500 focus:outline-none placeholder:text-blue-500"
                />
              </div>
            </div>
          )}
