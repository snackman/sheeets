            ...
            {itineraryEvents.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="p-1.5 text-blue-400 hover:text-orange-400 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  disabled={exporting}
                  className="p-1.5 text-blue-400 hover:text-orange-400 transition-colors cursor-pointer disabled:opacity-50"
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    shareStatus === 'copied'
                      ...
                      : 'bg-blue-900 border border-blue-700 text-blue-400 hover:text-orange-400 hover:border-blue-600'
                  )}
                  title="Share link"
                >
