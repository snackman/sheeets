...
export default function ItineraryPage() {
  ...
  const handleSharePNG = useCallback(async () => {
    ...
    try {
      ...
      const blob = await toBlob(captureRef.current, { backgroundColor: '#0f1c2e', pixelRatio: 2 });
    ...
    <div className={viewMode === 'map' ? 'h-screen flex flex-col bg-blue-950' : 'min-h-screen bg-blue-950'}>
            ...
            {itineraryEvents.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="p-1.5 text-blue-400 hover:text-yellow-400 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  disabled={exporting}
                  className="p-1.5 text-blue-400 hover:text-yellow-400 transition-colors cursor-pointer disabled:opacity-50"
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    shareStatus === 'copied'
                      ...
                      : 'bg-blue-900 border border-blue-700 text-blue-400 hover:text-yellow-400 hover:border-blue-600'
                  )}
                  title="Share link"
                >
      ...
      {itineraryEvents.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center px-4">
          ...
          <p className="text-blue-400 font-medium mb-2">No events in your itinerary yet</p>
                      ...
                      >
                        ...
                        <div
                          className={`bg-blue-900 rounded-lg p-3 border transition-opacity ${
                            hasConflict ? 'border-amber-500/40' : 'border-blue-700'
                        ...
                        >
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <button
                              ...
                              className="shrink-0 p-1 text-blue-500 hover:text-red-400 transition-colors cursor-pointer"
                          ...
                          {event.organizer && (
                            <p className="text-blue-500 text-xs mt-0.5 ml-6">By {event.organizer}</p>
                          )}

                          <p className="text-blue-400 text-xs mt-1 ml-6">{timeDisplay}</p>

                          {event.address && (
                            <AddressLink address={event.address} navAddress={event.matchedAddress} lat={event.lat} lng={event.lng}
                              eventId={event.id} eventName={event.name}
                              className="text-blue-500 hover:text-blue-300 text-xs mt-0.5 truncate block transition-colors ml-6">
                              {event.address}
                            </AddressLink>
                          )}
          ...
          <div className="mt-6 pt-4 border-t border-blue-800">
            {showClearConfirm ? (
              <div className="flex items-center gap-2">
                <span className="text-sm text-blue-400">Clear all events?</span>
                <button
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-blue-800 hover:bg-blue-700 text-blue-300 text-xs font-medium rounded transition-colors cursor-pointer"
                >
                  Cancel
                </button>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-900 hover:bg-blue-800 border border-blue-700 text-blue-400 hover:text-blue-300 rounded-lg text-sm font-medium transition-colors cursor-pointer"
              >
