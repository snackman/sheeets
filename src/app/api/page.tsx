...
function MethodBadge({ method }: { method: string }) {
  ...
  return (
    <span
      className={`inline-block px-2 py-0.5 text-xs font-bold rounded border ${colors[method] ?? 'bg-blue-800 text-blue-300 border-blue-600'}`}
    >
      {method}
    </span>
  );
...
function EndpointCard({
  ...
  return (
    <div className="bg-blue-900/50 border border-blue-700 rounded-lg p-5 mb-4">
      <div className="flex flex-wrap items-center gap-2 mb-3">
        <MethodBadge method={method} />
        <code className="text-sm font-mono text-yellow-300 break-all">
          {path}
        </code>
        <AuthBadge auth={auth} />
        {scopes && (
      ...
      <p className="text-sm text-blue-300 mb-3">{description}</p>
        ...
        <div className="mb-3">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-blue-500 text-xs">
              ...
              <tbody>
                {params.map((p) => (
                  <tr key={p.name} className="border-t border-blue-700/50">
                    <td className="py-1.5 pr-4">
                      <code className="text-xs text-yellow-300 font-mono">
                        {p.name}
                      </code>
                    </td>
                    <td className="py-1.5 pr-4 text-xs text-blue-400">
                      {p.type}
                    </td>
                    <td className="py-1.5 text-xs text-blue-400">
                      {p.description}
                    </td>
                  </tr>
                ))}
      ...
      {body && (
        <div className="mb-3">
          ...
          <div className="bg-blue-950 rounded p-3 overflow-x-auto">
    ...
    <div className="min-h-screen bg-blue-950">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 pb-24">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-blue-400 max-w-2xl mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="#endpoints"
              className="px-4 py-2 bg-blue-900 hover:bg-blue-800 border border-blue-700 text-blue-300 text-sm font-medium rounded-lg transition-colors"
            >
              Endpoints
            </a>
            <a
        ...
        {/* Table of contents */}
        <nav className="mb-12 p-4 bg-blue-900/50 border border-blue-700 rounded-lg">
...
print(data["events"])`,
        ...
        <p className="text-sm text-blue-400 mt-4">
          ...
          <a href="#authentication" className="text-yellow-400 hover:underline">
            API key
          </a>
          .
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <div className="bg-blue-900/50 border border-blue-700 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-300 mb-2">
              ...
              <a href="#api-keys" className="text-yellow-400 hover:underline">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-blue-300 mb-6">
          <li>
...
print(data)`,
  ...
  "revoked": true
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-blue-400 border-b border-blue-700">
            ...
            <tbody className="text-blue-300">
              {[
                ...
                <tr key={scope} className="border-b border-blue-700/50">
                  <td className="py-2.5 pr-4">
                    <code className="text-xs text-yellow-300 font-mono">
                      {scope}
                    </code>
                  </td>
                  <td className="py-2.5 text-blue-400">{desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="bg-blue-900/50 border border-blue-700 rounded-lg p-5 mb-6">
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-400">rate limit scope</p>
            </div>
            <div>
        ...
        <div className="bg-blue-950 border border-blue-700 rounded-lg p-4 overflow-x-auto mb-6">
          <pre className="text-sm text-blue-300 font-mono whitespace-pre">{`HTTP/1.1 429 Too Many Requests
Retry-After: 45
...

{
  ...
  "retry_after": 45
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <div>
            ...
            <div className="bg-blue-950 border border-blue-700 rounded-lg p-4 overflow-x-auto">
              <pre className="text-sm text-blue-300 font-mono whitespace-pre">{`{
  "events": [...],
  "total": 42
}`}</pre>
            </div>
  ...
  "status": 401
        ...
        <p className="text-sm text-blue-300 mb-4">Common HTTP status codes:</p>
          ...
          <table className="w-full text-sm mb-6">
            ...
            <tbody className="text-blue-300">
              {[
                ...
                <tr key={code} className="border-b border-blue-700/50">
                  <td className="py-2 pr-4">
                    <code className="text-xs font-mono text-yellow-300">
                      {code}
                    </code>
                  </td>
                  <td className="py-2 text-blue-400">{meaning}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-blue-300">
              {[
                ...
                <tr key={tool} className="border-b border-blue-700/50">
                  <td className="py-2 pr-4">
                    <code className="text-xs text-yellow-300 font-mono">
                      {tool}
                    </code>
                  </td>
                  <td className="py-2 text-blue-400">{desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-blue-400 hover:text-yellow-400 transition-colors"
              >
                GitHub
              </a>
              <Link
