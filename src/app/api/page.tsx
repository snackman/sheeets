...
function MethodBadge({ method }: { method: string }) {
  ...
  return (
    <span
      className={`inline-block px-2 py-0.5 text-xs font-bold rounded border ${colors[method] ?? 'bg-violet-800 text-violet-200 border-violet-700'}`}
    >
      {method}
    </span>
  );
...
function EndpointCard({
  ...
  return (
    <div className="bg-violet-900/50 border border-violet-800 rounded-lg p-5 mb-4">
      ...
      <p className="text-sm text-violet-200 mb-3">{description}</p>
        ...
        <div className="mb-3">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-violet-400 text-xs">
              ...
              <tbody>
                {params.map((p) => (
                  <tr key={p.name} className="border-t border-violet-800/50">
                    <td className="py-1.5 pr-4">
                      <code className="text-xs text-cyan-300 font-mono">
                        {p.name}
                      </code>
                    </td>
                    <td className="py-1.5 pr-4 text-xs text-violet-300">
                      {p.type}
                    </td>
                    <td className="py-1.5 text-xs text-violet-300">
                      {p.description}
                    </td>
                  </tr>
                ))}
      ...
      {body && (
        <div className="mb-3">
          ...
          <div className="bg-violet-950 rounded p-3 overflow-x-auto">
            <pre className="text-xs text-violet-200 font-mono whitespace-pre">
              {body}
            </pre>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-violet-950">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 pb-24">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-violet-300 max-w-2xl mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="#endpoints"
              className="px-4 py-2 bg-violet-900 hover:bg-violet-800 border border-violet-800 text-violet-200 text-sm font-medium rounded-lg transition-colors"
            >
              Endpoints
            </a>
            <a
        ...
        {/* Table of contents */}
        <nav className="mb-12 p-4 bg-violet-900/50 border border-violet-800 rounded-lg">
          ...
          <ul className="space-y-1.5 text-sm">
            {[
              ...
              <li key={href}>
                <a
                  href={href}
                  className="text-violet-300 hover:text-cyan-400 transition-colors"
                >
                  {label}
                </a>
              </li>
...
print(data["events"])`,
        ...
        <p className="text-sm text-violet-300 mt-4">
          ...
          <a href="#authentication" className="text-cyan-400 hover:underline">
            API key
          </a>
          .
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <div className="bg-violet-900/50 border border-violet-800 rounded-lg p-4">
            ...
            <p className="text-sm text-violet-200 mb-2">
              ...
              <a href="#api-keys" className="text-cyan-400 hover:underline">
                key management endpoints
              </a>
              .
            </p>
            <div className="bg-violet-950 rounded p-3 overflow-x-auto">
              <code className="text-xs text-violet-200 font-mono">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-violet-200 mb-6">
          <li>
...
print(data)`,
        ...
        <div className="bg-violet-900/50 border border-violet-800 rounded-lg p-4 mb-6">
  ...
  "revoked": true
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-violet-200">
              {[
                ...
                <tr key={scope} className="border-b border-violet-800/50">
                  <td className="py-2.5 pr-4">
                    <code className="text-xs text-cyan-300 font-mono">
                      {scope}
                    </code>
                  </td>
                  <td className="py-2.5 text-violet-300">{desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="bg-violet-900/50 border border-violet-800 rounded-lg p-5 mb-6">
          <div className="grid gap-4 sm:grid-cols-3">
            <div>
              <p className="text-2xl font-bold text-white">60</p>
              <p className="text-xs text-violet-300">requests per minute</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-white">Per Key</p>
              <p className="text-xs text-violet-300">rate limit scope</p>
            </div>
            <div>
        ...
        <div className="bg-violet-950 border border-violet-800 rounded-lg p-4 overflow-x-auto mb-6">
          <pre className="text-sm text-violet-200 font-mono whitespace-pre">{`HTTP/1.1 429 Too Many Requests
Retry-After: 45
...

{
  ...
  "retry_after": 45
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <div>
            ...
            <div className="bg-violet-950 border border-violet-800 rounded-lg p-4 overflow-x-auto">
              <pre className="text-sm text-violet-200 font-mono whitespace-pre">{`{
  "events": [...],
  "total": 42
}`}</pre>
            </div>
  ...
  "status": 401
        ...
        <p className="text-sm text-violet-200 mb-4">Common HTTP status codes:</p>
          ...
          <table className="w-full text-sm mb-6">
            ...
            <tbody className="text-violet-200">
              {[
                ...
                <tr key={code} className="border-b border-violet-800/50">
                  <td className="py-2 pr-4">
                    <code className="text-xs font-mono text-cyan-300">
                      {code}
                    </code>
                  </td>
                  <td className="py-2 text-violet-300">{meaning}</td>
                </tr>
              ))}
            </tbody>
          </table>
  ...
  "mcpServers": {
    "sheeets": {
      ...
      "env": {
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-violet-200">
              {[
                ...
                <tr key={tool} className="border-b border-violet-800/50">
                  <td className="py-2 pr-4">
                    <code className="text-xs text-cyan-300 font-mono">
                      {tool}
                    </code>
                  </td>
                  <td className="py-2 text-violet-300">{desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {/*  Footer                                                      */}
        {/* ============================================================ */}
        <div className="mt-16 pt-8 border-t border-violet-900">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-violet-300 hover:text-cyan-400 transition-colors"
              >
                GitHub
              </a>
              <Link
